...
PathToMilkyWayAtHomeClientFolder='/mnt/c/Users/guoy18/Newchange'
...
then
    ./milkyway_nbody \
    -f $PathToMilkyWayAtHomeClientFolder/for_developers.lua \
    -o $PathToMilkyWayAtHomeClientFolder/output/test.out \
    -z $PathToMilkyWayAtHomeClientFolder/output/test.hist \
